...
class ImageHandler(object):
    ...
    def create_html_file(self, web_dir, title, image_dir, epochs, epoch_freq, width):
        """
        ...
        label_real_img = "Real Img"
        label_fake_mask = "Fake Mask"
        label_gt = "GT"
        ...
        for n in range(epochs, 0, -1):
            ...
            if n % epoch_freq == 0:
                ...
                img_path_real_img = image_dir + "/epoch_%03d_real_img.png" % n
                img_path_fake_mask = image_dir + "/epoch_%03d_fake_mask.png" % n
                img_path_gt = image_dir + "/epoch_%03d_GT.png" % n
